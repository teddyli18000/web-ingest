...
- GitHub gap audit cross-validated **2026-01-04, 2026-04-15, 2026-07-01, and 2026-08-31** in `fdciabdul/Google-Trends-Keywords-Scraper`: all four regions are present and its collector directly uses Google Trending RSS. However the repository advertises **All Rights Reserved**, so it is research evidence only and is not approved for bulk historical import without clearer permission.
